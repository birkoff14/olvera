    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('UsoCFDI', models.CharField(blank=True, max_length=150)),
                ('SubTotal', models.CharField(blank=True, max_length=150)),
                ('Descuent', models.CharField(blank=True, max_length=150)),
                ('Total_IEP', models.CharField(blank=True, max_length=150)),
                ('IVA_16', models.CharField(blank=True, max_length=150)),
                ...
                ('IEPS_26', models.CharField(blank=True, max_length=150)),
