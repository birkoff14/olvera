...
#    for ark in files:
#        #print(root + "/" + ark)
#with os.scandir(directorio) as dir:
#    for x in dir:
#        print(x.name)
...
for root, dirs, files in os.walk(directorio):
    for ark in files:
        if fnmatch.fnmatch(ark,'*.xml'):  
            ...
            #try:
            existeArchivo = "select count(*) from conciliacion_comprobante where UUIDInt = '" + ark + "';"
            print(existeArchivo)
            ...
            if resp == 0:
                ...
                try:  
                    ...
                    #print ("%d Comprobante:" % Comprobante.length)
                    ...
                    for skill in Concepto:
                        ...
                        #print("Concepto:" + skill.getAttribute("Descripcion"))
